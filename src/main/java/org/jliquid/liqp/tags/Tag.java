...
public abstract class Tag extends LValue {
    ...
    /**
     * Used for all package protected tags in the liqp.tags-package whose name
     * is their class name lower cased.
     */
    protected Tag() {
     ...
     * Renders this tag.
     *
     * @param context the context (variables) with which this node should be
     * rendered.
     * @param nodes the nodes of this tag is created with. See the file
     * `src/grammar/LiquidWalker.g` to see how each of the tags is created.
     *
