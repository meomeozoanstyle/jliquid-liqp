...
import org.jliquid.liqp.nodes.AtomNode;

/**
 * An abstract class the Filter and Tag classes extend.
 * <p/>
 * It houses some utility methods easily available for said classes.
 */
public abstract class LValue {

    /**
     * Returns true if a and b are equals, where (int) 1 is equals to (double)
     * 1.0
     *
     * @param a the first object to compare.
     * @param b the second object to compare.
     *
     * @return true if a and b are equals, where (int) 1 is equals to (double)
     * 1.0
     */
    ...
    /**
     * Returns this value as an array. If a value is already an array, it is
     * casted to a `Object[]`, if it's a `java.util.List`, it is converted to an
     * array and in all other cases, `value` is simply returned as an `Object[]`
    ...
    /**
     * Convert `value` to a boolean. Note that only `nil` and `false` are
    ...
    /**
     * Returns `value` as a Number. Strings will be coerced into either a Long
     * or Double.
     *
     ...
     *
     * @throws NumberFormatException when `value` is a String which could not be
     * parsed as a Long or Double.
     */
    ...
    /**
     * Returns true if `value` is a whole number (Integer or Long).
     *
     * @param value the value to check.
     *
     * @return true if `value` is a whole number (Integer or Long).
     */
